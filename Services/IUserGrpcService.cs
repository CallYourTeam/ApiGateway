namespace ApiGateway.Services
{
    public interface IUserGrpcService
    {
        ...
        Task<UpdateUserGrpcResponse> UpdateUserAsync(Guid userId, string password, string login, string email, string newPassword, List<Guid> friends, List<Guid> groups, List<Guid> chanels);
